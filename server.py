...
def get_circulating_supply():
    ...
    veolas_total_supply = olas_contract.functions.balanceOf(VEOLAS_CONTRACT_ADDRESS).call()
    buolas_total_supply = olas_contract.functions.balanceOf(BUOLAS_CONTRACT_ADDRESS).call()
    ...
    circulating_supply = total_supply - veolas_total_supply - buolas_total_supply - valory_multisig - timelock
